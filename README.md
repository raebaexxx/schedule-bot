...
30 тестов: разбор дат/ФИО/аудиторий/ссылок, регрессия полного пайплайна по
фикстурам из `data/`, фильтры дат, форматирование.
...
handlers.py          команды, inline-меню, навигация
formatter.py         рендер сообщений с фильтрацией по дате
